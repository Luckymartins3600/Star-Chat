...
class FriendsStatusWidget extends StatelessWidget {
  final bool isDark;
  const FriendsStatusWidget({Key key, @required this.isDark}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      title: Html(
        data: '<p><i> Your friend <b>Lucky Flamze</b> posted a status.</i></p>',
        style: {
