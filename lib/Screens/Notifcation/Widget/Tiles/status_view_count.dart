...
class StatusViewsWidget extends StatelessWidget {
  final bool isDark;
  const StatusViewsWidget({Key key, @required this.isDark}) : super(key: key);
      ...
      leading: CircleAvatar(
        ...
        child: Align(
          ...
          child: CircleAvatar(
            ...
            child:
                Icon(CupertinoIcons.eye_fill, size: size(context).width / 30),
          ),
        ),
      ),
      title: const Text('You got 34 views on your status'),
      subtitle: Text(
